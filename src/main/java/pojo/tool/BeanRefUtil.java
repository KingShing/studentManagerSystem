...
public class BeanRefUtil {
	...
	/**
	 * 复制source -> target (并过滤值为0/0.0/""等置null,以免影响推送) 属性的复制建议采用：Dozer
	 * 
	 * @param source
	...
	/**
	 * * 将相应的bean转化为map(属性->value) * * @param source * @return
	 * 
	 */
	...
	/**
	 * * 将实体source有更新的属性更新到对应的实体target * * @param target * @param valMap
	 */

	private static void setNoUpdateFieldToNull(Object target, Map<String, String> valMap, Class annotation) {
	...
	/**
	 * 将实体source有更新的属性更新到对应的实体target 并判断新老对象值是否是一致(即是否需要更新到数据库)
	 * 
	 * @param target
	 * @param valMap
	 */
	private static boolean updateFieldValue(Object target, Map<String, String> valMap) {
		boolean flag = false;
	...
	/**
	 * * 根据字段获取对应的值 * * @param bean * @param field * @return * @throws Exception
	 */
	public static String getFieldValue(Object bean, Field field) throws Exception {
	...
	/**
	 * * 根据属性设置值,仅支持基本类型 
 		@param bean * @param field * @param value *
 		 @throws Exception
	 */
	...
	/**
	 * * 判断实体属性值是否全部为null * @param bean * @return
	 */
	...
	/**
	 * * 判断某个字段的get方法是否有指定的annotation * @param bean * @param field * @param
	 * annotation * @return * @throws Exception
	 */
	...
	/**
	 * * 判断是否存在某属性的 set方法 * * @param methods * @param fieldSetMet * @return
	 */
	...
	/**
	 * * 判断是否存在某属性的 get方法 * * @param methods * @param fieldGetMet * @return
	 */
	...
	/**
	 * * 拼接某属性的 get方法 * * @param fieldName * @return
	 */
	...
	/**
	 * * 拼接在某属性的 set方法 * * @param fieldName * @return
	 */
	...
	/**
	 * * 判断字段名是否包含id,将其过滤 * @param fieldName * @return
	 */
